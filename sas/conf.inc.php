...
// | APR-26-04 - Updateds function show days ...................... v1.4.0 |
...
// +----------------------------------------------------------------------+
	...
	$banco="helpi302_sas";			 // NAO ALTERAR (somente se necessario)
					 // DONT CHANGE (only if necessary)
	$usuario="helpi302_root";	 // USUARIO BD  - DB USER
	$senhadb="190470";	 // SENHA BD    - DB PASSWORD
	$servidor="localhost"; // IP SERVIDOR - SERVER IP
