...
<script Language="JavaScript">
	...
	<TABLE width="520" width="522" >
		<TR>
			<TD ><center>
				...
				<input type="radio" name="tempo" value="0" OnClick="javascript: alert('<?php echo $L_DURACAO; ?>: 0 <?php echo $L_HORA; ?>');">  0 &nbsp;&nbsp;
	...
	<center><font face="verdana,arial" size="1" color="#4682B4">SAS v.<?php include('versao.inc.php'); echo $versao; ?> - Magni Consultórios - http://www.magniconsultorios.com.br
	<?php
...
if($enviar=="sim"){ 
	...
	if(($env_cod_sala)||($proxima)||($anterior)){ // REF_005
		...
		if($codsala){ // REF_006
			...
			if($dia_da_semana2==2){   $dia_da_semana="Ter�a";   $inicio=-1; $inicio2=-1; $iniciok=2; $inicio_prox=6; }
			...
			if($dia_da_semana2==6){   $dia_da_semana="S�bado";  $inicio=-5; $inicio2=-5; $iniciok=6; $inicio_prox=2; }
