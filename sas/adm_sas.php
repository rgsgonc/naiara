...
<html>
   ...
   <body class="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="initEditor()" >
            ...
            <td align="center" >
               ...
               <table border="0" width="100%">
                  ...
                  <?php
                     ...
                     $resultado = mysqli_query($db,$sqlus) or die(mysqli_error($db));
                     $ci=0;
                  ...
                  <tr bgcolor="#<?php if($ci==0){ echo("FFFFFF"); $ci=1; } else { echo("F5F5F5"); $ci=0; } ?>">
                     ...
                     <td align="left">
                        ...
                        <center>
                        <a href="?novosusuarios=sim&adm=sim&adm_usuarios=sim&eduser=<?php echo $linha_us["matsup"]; ?>"><img src="img/editar.gif" border="0" alt="Ediar dados de: <?php echo $linha_us["nome_sup"]; ?>"></a>
                     </td>
                     <td align="left">
                        <font size=1 face="arial">
                        <center>
                        <a href="?novosusuarios=sim&adm=sim&adm_usuarios=sim&apauser=<?php echo $linha_us["matsup"]; ?>&usu=<?php echo $linha_us["nome_sup"]; ?>"><img src="img/apagar.gif" border="0" alt="Editar dados de: <?php echo $linha_us["nome_sup"]; ?>"></a>
                     </td>
                  </tr>
                  <?php
                     } // FIM WHILE_US
            ...
            <td align="center" >
               ...
               <table border="0" width="100%">
                  ...
                  <?php
                     ...
                     $resultadoadm = mysqli_query($db,$sqladm) or die(mysql_error());
                     $ci=0;
                     while($linha_adm=mysqli_fetch_array($resultadoadm)) { // INICIO WHILE_US
                  ...
                  <tr bgcolor="#<?php if($ci==0){ echo("FFFFFF"); $ci=1; } else { echo("F5F5F5"); $ci=0; } ?>">
                     ...
                     <td align="left">
                        <font size=1 face="arial">
                        <center>
                        <a href="?novosusuarios=sim&adm=sim&adm_usuarios=sim&edadm=<?php echo $linha_adm["matsup"]; ?>"><img src="img/editar.gif" border="0" alt="Ediar dados de: <?php echo $linha_adm["nome"]; ?>"></a>
                     </td>
                     <td align="left">
                        <font size=1 face="arial">
                        <center>
                        <a href="?novosusuarios=sim&adm=sim&apaadm=<?php echo $linha_adm["matsup"]; ?>"><img src="img/apagar.gif" border="0" alt="Apagar dados de: <?php echo $linha_adm["nome"]; ?>"></a>
                     </td>
                  </tr>
                  <?php
                     } // FIM WHILE_US
            ...
            <td align="center">
               ...
               <table width="100%" align="center">
                  <tr>
					 ...
					 <td align="left">
                     	<input class="bordas" type="text" size="15" name="matricula" id="matricula" value="<?php if($novo){ echo(""); } else { echo $linha["matsup"]; } ?>"><br>
					 </td>

					 <td align="left">
                     	<input class="bordas" type="hidden" size="15" name="matriculaEditar" id="matriculaEditar" value="<?php if($novo){ echo(""); } else { echo $linha["matsup"]; } ?>"><br>
                     </td>
         ...
         <tr align="center">
            <td align="center">
               ...
               <table width="100%" align="center">
                  <tr>
                     <td  align="right">
                        <form name="edusersform" method="post" action="?novosusuarios=sim&adm=sim&adm_usuarios=sim">
                           <font face="arial,verdana" size="2">CPF: </font><br>
                     </td>
                     <td align="left">
					  <!--Se o usuário for novo ele nao mostra nada, se for usuario existente bota o numero da matricula na tela.-->
                     <input class="bordas" type="text" size="15" name="matricula" id="matricula" value="<?php if($novo){ echo(""); } else { echo $linha["matsup"]; } ?>"><br>
					 </td>
                  ...
                  <td align="left">	
                  <input class="bordas" type=text size="40" name="nome" id="nome" value="<?php if($novo){ echo(""); } else { echo $linha["nome_sup"]; } ?>"><br>
                  </td>
                  </tr>
                  <tr>
                  <td align="right">
      ...
      <?php
		 ...
		 $matriculaEditar=$_POST["matriculaEditar"];
         $nome=$_POST["nome"];
         $ilha=$_POST["ilha"];
         $pri=$_POST["pri"];
         
		 //$sql = "UPDATE sups SET matsup='$matricula',nome_sup='$nome',ilha='$ilha',pri='$pri',senha='$matricula' WHERE matsup = $matricula";
		 $sql = "UPDATE sups SET matsup='$matricula',nome_sup='$nome',ilha='$ilha',pri='$pri',senha='$matricula' WHERE matsup = '$matriculaEditar'";

         if(mysqli_query($db,$sql)){
         	echo ("<SCRIPT LANGUAGE=\"JavaScript\"> function tela(){ alert('Usuário $nome atualizado com sucesso!'); window.navigate('?novosusuarios=sim&adm=sim&adm_usuarios=sim&usuarios5=sim'); } </SCRIPT> <script language=\"javascript\"> tela(); </script>");
         } else {
         	echo ("<i><b><font face=\"arial,verdana\" size=\"-1\">USUÁRIO NAO ATUALIZADO. CONTATE O SUPORTE LOCAL!!!</i><br> ERRO MySQL:</b> ". mysqli_error($db));
         }
      ...
      <table bgcolor="#ffffff" align="center" width="100%" class="bordas">
         <tr>
            <td width="90%" align="center">
               ...
               <center>
               Todos os dados referente ao usuário <b><?php echo $usu; ?></b> seram apagados.<br><br><font size="3"><b> Deseja realmente apagar este usuário?</b> <br><br>
      ...
      <?php
			 ...
			 $sql1 = "DELETE FROM sups WHERE matsup = $apauser";
         
         	if(!mysqli_query($db,$sql1)){
         		echo ("<i><b><font face=\"arial,verdana\" size=\"-1\">USUÁRIO NAO APAGADO. CONTATE O SUPORTE LOCAL!!!</i><br> ERRO MySQL:</b> ". mysqli_error($db));
         		exit();
         	}
         	...
         	if(mysqli_query($db,$sql)){
         		echo ("<SCRIPT LANGUAGE=\"JavaScript\"> function tela(){ alert('Usuário apagado(a) com sucesso!'); window.navigate('?novosusuarios=sim&adm=sim&adm_usuarios=sim&usuarios5=sim'); } </SCRIPT> <script language=\"javascript\"> tela(); </script>");
         	} else {
         		echo ("<i><b><font face=\"arial,verdana\" size=\"-1\">USUÁRIO NAO APAGADO. CONTATE O SUPORTE LOCAL!!!</i><br> ERRO MySQL:</b> ". mysqli_error($db));
         	}
         }
		 ...
		 $sql = "UPDATE adms SET matsup='$matricula',nome='$nome',senha='$senha' WHERE matsup = '$matriculaEditar'";
		 echo($sql);
      ...
      <table bgcolor="#ffffff" align="center" width="100%" class="bordas">
         <tr>
            <td width="90%" align="center">
               <font face="arial" size="2">
               <center>
               Todos os dados referente ao admin <b><?php echo $apaadm; ?></b> seram apagados.<br><br><font size="3"><b> Deseja realmente apagar este Admin?</b> <br><br>
